...
var popupButton = document.querySelector('.header-mail');
var popupClose = document.querySelector('.popup-form-close');

if(popupButton) {
	popupButton.addEventListener('click', showPopup.bind(this));
